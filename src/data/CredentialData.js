const CredentialData = [
  {
    ...
    jobLocation : "Port of Singapore Authority",
    jobPoints: [
  ...
  },
  {
    ...
    jobLocation : "School of Computing, NUS",
    jobPoints: [
  ...
  {
    jobName : "Independent Solutions Developer",
    jobLocation : "Kydon Learning Systems Institute",
    jobPoints: [
  ...
  {
    jobName : "Intelligence Specialist",
    jobLocation : "Singapore Armed Forces",
    jobPoints: [
  ...
  {
    jobName : "Risk Assurance Temporary Assistant",
    jobLocation : "PriceWaterhouseCoopers Singapore",
    jobPoints: [
